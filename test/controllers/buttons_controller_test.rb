...
class ButtonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create button" do
    assert_difference('Button.count') do
      post buttons_url, params: { button: { colour: @button.colour, description: @button.description, price: @button.price, size: @button.size } }
    end
  ...
  test "should update button" do
    patch button_url(@button), params: { button: { colour: @button.colour, description: @button.description, price: @button.price, size: @button.size } }
